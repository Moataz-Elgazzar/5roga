...
class _PlacedetailsScreenState extends State<PlacedetailsScreen> {
        ...
        actions: [
          if (role == null)
            ...
            IconButton(
              ...
              onPressed: () async {
                final newValue = await toggleFavorite();
                if (!mounted) return;
                setState(() {
                  isFavorite = newValue;
                });
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              workHour(),
              const Gap(20),
              widget.model?.englishPlaceCategories == 'restaurant' || widget.model?.englishPlaceCategories == 'cafe' ? menu(context) : const SizedBox(),
              const Gap(20),
              if (role == 'user') rating(),
              const Gap(20),
              ContactUs(widget: widget),
              const Gap(15),
              if (role == 'user') add5roga(context),
            ],
          ),
        ),
      ),
  ...
  MainButtonCustom add5roga(BuildContext context) {
...
class ContactUs extends StatelessWidget {
  const ContactUs({super.key, required this.widget});
